...
namespace LightningDB
{
    class Native64BitLibraryFacade : INativeLibraryFacade
    {
        ...
        [DllImport(LibraryName, CallingConvention = CallingConvention.Cdecl)]
        private static extern string mdb_version(out int major, out int minor, out int patch);
        ...
        {
            return mdb_env_get_maxreaders(env, out readers);
        }
        ...
        {
            return mdb_dbi_open(txn, name, flags, out db);
        }
        ...
        {
            return mdb_txn_begin(env, parent, flags, out txn);
        }
        ...
        string INativeLibraryFacade.mdb_version(out int major, out int minor, out int patch)
        {
            return mdb_version(out major, out minor, out patch);
        }
        ...
        {
            return mdb_cursor_get(cursor, ref key, ref data, op);
        }
