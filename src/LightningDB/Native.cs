...
namespace LightningDB
{
    internal static class Native
    {
        ...
        /// </returns>
        [DllImport("lmdb", CallingConvention = CallingConvention.Cdecl)]
        public static extern int mdb_env_open(IntPtr env, string path, EnvironmentOpenFlags flags, UnixAccessMode mode); //OK
        ...
        /// </returns>
        [DllImport("lmdb", CallingConvention = CallingConvention.Cdecl)]
        public static extern int mdb_env_set_mapsize(IntPtr env, Int32 size); //OK
        ...
        /// </returns>
        [DllImport("lmdb", CallingConvention = CallingConvention.Cdecl)]
        public static extern int mdb_env_get_maxreaders(IntPtr env, out UInt32 readers); //OK
        ...
        /// </returns>
        [DllImport("lmdb", CallingConvention = CallingConvention.Cdecl)]
        public static extern int mdb_env_set_maxreaders(IntPtr env, UInt32 readers); //OK
        ...
        /// </returns>
        [DllImport("lmdb", CallingConvention = CallingConvention.Cdecl)]
        public static extern int mdb_env_set_maxdbs(IntPtr env, UInt32 dbs); //OK
        ...
        /// </returns>
        [DllImport("lmdb", CallingConvention = CallingConvention.Cdecl)]
        public static extern int mdb_dbi_open(IntPtr txn, string name, DatabaseOpenFlags flags, out UInt32 db); //OK
        ...
        [DllImport("lmdb", CallingConvention = CallingConvention.Cdecl)]
        public static extern void mdb_dbi_close(IntPtr env, UInt32 dbi); //OK
        ...
        /// <returns>A non-zero error value on failure and 0 on success.</returns>
        [DllImport("lmdb", CallingConvention = CallingConvention.Cdecl)]
        public static extern int mdb_drop(IntPtr txn, UInt32 dbi, bool del); //OK
        ...
        /// </returns>
        [DllImport("lmdb", CallingConvention = CallingConvention.Cdecl)]
        public static extern int mdb_txn_begin(IntPtr env, IntPtr parent, TransactionBeginFlags flags, out IntPtr txn); //OK
        ...
        /// </returns>
        [DllImport("lmdb", CallingConvention = CallingConvention.Cdecl)]
        public static extern int mdb_txn_commit(IntPtr txn); //OK
        ...
        /// <param name="txn">A transaction handle returned by mdb_txn_begin()</param>
        [DllImport("lmdb", CallingConvention = CallingConvention.Cdecl)]
        public static extern void mdb_txn_abort(IntPtr txn); //OK
        ...
        /// <param name="txn">A transaction handle returned by mdb_txn_begin()</param>
        [DllImport("lmdb", CallingConvention = CallingConvention.Cdecl)]
        public static extern void mdb_txn_reset(IntPtr txn); //OK
        ...
        /// </returns>
        [DllImport("lmdb", CallingConvention = CallingConvention.Cdecl)]
        public static extern int mdb_txn_renew(IntPtr txn); //OK
        ...
        [DllImport("lmdb", CallingConvention = CallingConvention.Cdecl)]
        public static extern string mdb_version(out int major, out int minor, out int patch); //OK
        ...
        [DllImport("lmdb", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr mdb_strerror(int err); //OK
        ...
        /// <returns>A non-zero error value on failure and 0 on success.</returns>
        [DllImport("lmdb", CallingConvention = CallingConvention.Cdecl)]
        public static extern int mdb_env_copy(IntPtr env, string path); //OK
        ...
        /// </returns>
        [DllImport("lmdb", CallingConvention = CallingConvention.Cdecl)]
        public static extern int mdb_env_sync(IntPtr env, bool force); //OK
        ...
        /// </returns>
        [DllImport("lmdb", CallingConvention = CallingConvention.Cdecl)]
        public static extern int mdb_cursor_open(IntPtr txn, UInt32 dbi, out IntPtr cursor); //OK
        ...
        [DllImport("lmdb", CallingConvention = CallingConvention.Cdecl)]
        public static extern void mdb_cursor_close(IntPtr cursor); //OK
        ...
        /// </returns>
        [DllImport("lmdb", CallingConvention = CallingConvention.Cdecl)]
        public static extern int mdb_cursor_renew(IntPtr txn, IntPtr cursor); //OK
